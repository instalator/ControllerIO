...
void AnalogRead() {
  ...
  if (Ain_1 == 1 || (Ain_1 == 2 && old_Ain_1 == 0)) {
    Ain_1 = 0;
  }
  if (Ain_2 == 1 || (Ain_2 == 2 && old_Ain_2 == 0)) {
    Ain_2 = 0;
  }
  if (Ain_3 == 1 || (Ain_3 == 2 && old_Ain_3 == 0)) {
    Ain_3 = 0;
  }
  if (Ain_4 == 1 || (Ain_4 == 2 && old_Ain_4 == 0)) {
    Ain_4 = 0;
  }
  if (Ain_1 - 2 == old_Ain_1) {
    Ain_1 = old_Ain_1;
  }
  if (Ain_2 - 2 == old_Ain_2) {
    Ain_2 = old_Ain_2;
  }
  if (Ain_3 - 2 == old_Ain_3) {
    Ain_3 = old_Ain_3;
  }
  if (Ain_4 - 2 == old_Ain_4) {
    Ain_4 = old_Ain_4;
  }
...
void ReadDS18() {
  ...
  float Temp1 = DS_sensors.getTempC(addr_T1);
  client.publish("myhome/controller/Temperature_1", FloatToChar(Temp1));
}
...
void ReadDHT() {
  ...
  if (Hout != 0 || Tout != 0) {
    client.publish("myhome/controller/DHT_humidity", FloatToChar(Hout));
    client.publish("myhome/controller/DHT_temperature", FloatToChar(Tout));
  }
